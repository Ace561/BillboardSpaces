...
export default function EventCalender({ navigation }) {
    ...
    const EventComponent = ({ events }) => {
        return (
            <Pressable onPress={() => navigation.navigate("Eventclicked", { data: events })}>
                <View style={{ alignItems: 'center', marginTop: 20 }}>
                    <Image borderRadius={20} resizeMode='contain' source={{ uri: events.image }} style={styles.billboardImage} />
                </View>
