  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView style={{ marginBottom: 5 }} horizontal={false} showsVerticalScrollIndicator={false}>
        <Text style={{ fontSize: 28, fontWeight: '500', marginLeft: 16 }}>Community</Text>
        ...
        <ScrollView horizontal={true} showsHorizontalScrollIndicator={false} style={{ paddingTop: 10 }}>
          <TouchableOpacity onPress={toggleAdDetails} style={[styles.buttonParent, activeButton === 'ad' ? styles.activeButton : null]}>
            <Text style={[styles.button, activeText === 'ad' ? styles.activeText : null]}>Advertisements</Text>
          </TouchableOpacity>
                  ...
                  <TouchableWithoutFeedback onPress={() => console.log('Tapped inside modal')}>
                    <View style={styles.modalContent}>
                      <ScrollView showsVerticalScrollIndicator={false}>
                        <Text style={{ marginLeft: 16, fontSize: 22, fontWeight: '500' }}>Post Advertisement</Text>
        ...
        {showForumDetails && (
          <View>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginRight: 10, marginLeft: 16, marginTop: 10 }}>
              <Text style={{ fontWeight: '500', fontSize: 22, color: '#1E1E1E' }}>Popular Groups</Text>
              <Text style={{ color: '#0080FE', fontWeight: '500', fontSize: 14 }}>Create New Group</Text>
            </View>
            ...
            <Text style={{ fontWeight: '500', fontSize: 22, color: '#1E1E1E', marginLeft: 16, marginTop: 20 }}>Around you</Text>
