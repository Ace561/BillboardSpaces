    ...
    return (
        <SafeAreaView style={styles.container}>
            <ScrollView style={{ marginBottom: 5 }} horizontal={false} showsVerticalScrollIndicator={false}>
                <View style={{ flexDirection: 'row', paddingLeft: 16, gap: 16, marginTop: 10 }}>
                    <AntDesign style={{ alignSelf: 'center' }} onPress={() => navigation.goBack()} name="arrowleft" size={30} color="#383838" />
                    <Text style={{
                        alignSelf: 'center',
                        fontWeight: '500',
                        fontSize: 22,
                ...
                <View style={{ alignItems: 'center', marginTop: 20 }}>
                    <Image borderRadius={20} resizeMode='contain' source={{ uri: data.image }} style={styles.billboardImage} />
                </View>
                ...
                <View style={{
                    ...
                    <Text style={{ fontWeight: '400', fontSize: 14, marginTop: 10, lineHeight: 16.94, color: '#383838' }}>{data.description}</Text>
                </View>
                ...
                <View style={{
                    ...
                    <View style={{ flexDirection: 'column' }}>
                        <View style={{ flexDirection: 'row' }}>
                            <MaterialCommunityIcons style={{}} name="map-marker" size={20} color="#383838" />
                            <Text style={{
                                fontSize: 12,
                                fontWeight: '400',
                                lineHeight: 14.52
