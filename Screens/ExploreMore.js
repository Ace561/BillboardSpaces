            ...
            <ScrollView style={{ marginBottom: 5 }} horizontal={false} showsVerticalScrollIndicator={false}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingLeft: 16, paddingRight: 10, paddingTop: 10 }}>
                    ...
                    <View style={{
                        ...
                        <Image style={{ alignSelf: 'center' }} source={require('../assets/avalable.png')} />
                        <Text style={{
                            fontWeight: '400',
                            fontSize: 14,
                            lineHeight: 16.94,
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingLeft: 16, paddingRight: 10, marginTop: 10 }}>
                ...
                {showDetails && (
                    <View>
                        <Text style={{ fontSize: 14, paddingLeft: 16, color: '#0080FE', padding: 10, fontWeight: '500' }}>DIY Design with Canva API</Text>
                        <Text style={{ fontSize: 14, paddingLeft: 16, color: '#0080FE', fontWeight: '500' }}>Book Professional Design Services</Text>
                    </View>
                )}
