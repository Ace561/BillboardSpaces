...
reset it`}</Text>
                        ...
                        <Modal visible={newPasswordModalVisible} transparent={true} animationType="fade">
                            <Pressable style={styles.modalContainer} onPress={CloseNewPasswordModalVisible}>
                                <TouchableWithoutFeedback onPress={() => console.log('Tapped inside modal')}>
                                    <View style={styles.modalContent}>
                                        <Text style={styles.forgotYourPassword1}>Reset Password</Text>
                                        <View style={[styles.rectangleView2,
                                        ModalPasswordFocused && { borderColor: "#0080fe", borderWidth: 1 }
                                        ]}>
                                            <TextInput
                                                style={styles.email}
                                                placeholder="Password"
                                        ...
                                        <TouchableOpacity onPress={handleSubmitPassword} style={styles.buttonParent}>
