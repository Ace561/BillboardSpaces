    ...
    return (
        <SafeAreaView style={styles.container}>
            <ScrollView showsVerticalScrollIndicator={false}>
                        ...
                        <View style={styles.DetailsContainer}>
                            ...
                            <View style={styles.Details}>
                                ...
                                <Text style={styles.detailsText}>
                                    ...
                                    (e.g. favorite billboards, location-based filters).
                                </Text>
                            </View>
                    ...
                    <View>
                        ...
                        <View style={styles.DetailsContainer}>
                            ...
                            <View style={styles.Details2}>
                                <View style={styles.circle}></View>
                                <Text style={styles.detailsText}>
                                    Exclusive access to premium billboards
                                    (e.g., limited-edition artworks, celebrity endorsements).
                                </Text>
                            </View>
                            ...
                            <View style={styles.Details2}>
                                ...
                                <Text style={styles.detailsText}>
                                    ...
                                    (e.g., custom themes, font styles).                                </Text>
                            </View>
                            ...
                            <View style={styles.Details}>
                                <View style={styles.circle}></View>
                                <Text style={styles.detailsText}>
                                    Ability to submit user-generated billboards.                             </Text>
                            </View>
                    ...
                    <View>
                        ...
                        <View style={styles.DetailsContainer}>
                            ...
                            <View style={styles.Details2}>
                                ...
                                <Text style={styles.detailsText}>
                                    Personalized
                                    recommendations based on user preferences.                             </Text>
                            </View>
                            ...
                            <View style={styles.Details}>
                                ...
                                <Text style={styles.detailsText}>
                                    ...
                                    collections of favorite billboards.                             </Text>
                            </View>
                ...
                <ScrollView showsHorizontalScrollIndicator={false} horizontal={true} style={{ marginTop: 50, flex: 1 }}>
                    <TouchableOpacity onPress={toggleAdDetails} style={[styles.buttonParent, activeButton === 'ad' ? styles.activeButton : null]}>
                        <Text style={[styles.button, activeText === 'ad' ? styles.activeText : null]}>Basic Tier</Text>
                        <Text style={[styles.button, activeText === 'billboard' ? styles.activeText : null]}>$100/month</Text>

                    </TouchableOpacity>
                    <TouchableOpacity onPress={toggleProTierDetails} style={[styles.buttonParent2, activeButton === 'pro' ? styles.activeButton : null]}>
                        <Text style={[styles.button, activeText === 'pro' ? styles.activeText : null]}>Pro Tier</Text>
                        <Text style={[styles.button, activeText === 'pro' ? styles.activeText : null]}>$500/month</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={toggleBillboardDetails} style={[styles.buttonParent3, activeButton === 'billboard' ? styles.activeButton : null]}>
                        <Text style={[styles.button, activeText === 'billboard' ? styles.activeText : null]}>Premium Tier</Text>
                        <Text style={[styles.button, activeText === 'billboard' ? styles.activeText : null]}>$1000/month</Text>
                    </TouchableOpacity>

                </ScrollView>

                <TouchableOpacity style={{ marginTop: 60, width: "100%", height: 40, backgroundColor: '#0080FE', justifyContent: 'center', borderRadius: 10, bottom: 10 }}>
