            ...
            <ScrollView style={{ marginBottom: 5 }} horizontal={false} showsVerticalScrollIndicator={false}>
                ...
                <View style={{ alignSelf: 'center', width: '80%', height: 57, marginTop: 10 }}>
                    <Text style={{ fontSize: 16, fontWeight: '400', textAlign: 'justify', lineHeight: 19 }}>
                        ...
                        Platforms. our Team will respond to you as
                        soon as Possible
                    </Text>
                </View>
                ...
                <Feather onPress={openPhoneBook} style={{ alignSelf: 'center', marginTop: 16 }} name="phone" size={29} color="#0080FE" />
                ...
                <Fontisto onPress={openMailApp} style={{ alignSelf: 'center', marginTop: 16 }} name="email" size={29} color="#0080FE" />
                <Text style={{
                    fontWeight: '400',
                    fontSize: 16,
                    textAlign: 'justify',
                    ...
                    alignSelf: 'center',
                    marginTop: 16
                }}>billboardspacesng@gmail.com</Text>
            </ScrollView>
        </SafeAreaView>
    )
}
